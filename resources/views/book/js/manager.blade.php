                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        markEventListener = function() {
                            ...
                            if (!window.signatureImg) { window.signatureImg = new Image(); window.signatureImg.src = signature; }

                            if (!window.signatureImgLoaded) {
                                window.signatureImgLoaded = false;
                                window.signatureImg.onload = function(){ window.signatureImgLoaded = true; };
                            }

                            if (!window.signatureCoordinates) { window.signatureCoordinates = null; }
                            ...
                            function redrawSignatureBoxes(){
                                ...
                                if (hasImage) {
                                    ...
                                    var imgW=imageBox.endX-imageBox.startX, imgH=imageBox.endY-imageBox.startY; if (window.signatureImgLoaded){ markCtx.drawImage(window.signatureImg, imageBox.startX, imageBox.startY, imgW, imgH); imgData={x:imageBox.startX,y:imageBox.startY,width:imgW,height:imgH}; }
                                }
                                // bottom box
